...
public class Joueur {
	...
	public void setNom(String nom) throws BeanException {
		if (nom.length() > 20) throw new BeanException("Le nom est trop long, 20 caractères maximum");
		else this.nom = nom;
	}
	...
	public void setPrenom(String prenom) throws BeanException {
		if (prenom.length() > 20) throw new BeanException("Le prénom est trop long, 20 caractères maximum");
